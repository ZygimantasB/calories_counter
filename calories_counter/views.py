...
from .forms import SelectFoodForm,AddFoodForm,ProfileForm
from .models import *
...
def HomePageView(request):
    ...
    return render(request, 'calories_counter/home.html',context)
...
def RegisterPage(request):
    if request.user.is_authenticated:
        ...
        context = {'form':form}
        return render(request,'calories_counter/register.html',context)
...
def LoginPage(request):
    if request.user.is_authenticated:
        ...
        context = {}
        return render(request,'calories_counter/login.html',context)
...
def select_food(request):
    ...
    return render(request, 'calories_counter/select_food.html',context)
...
def add_food(request):
    ...
    return render(request,'calories_counter/add_food.html',context)
...
def ProfilePage(request):
    ...
    return render(request, 'calories_counter/profile.html',context)